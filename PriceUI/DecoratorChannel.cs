...
namespace PriceUI
{
    ...
    public class DecoratorChannel
    {
        ...
        // Painting stacks
        private PaintChannel decoratorPrice = new PaintChannel();
        private PaintChannel decoratorAverage = new PaintChannel();
        private PaintChannel decoratorHistory = new PaintChannel();
        public PaintChannel getDecoratorPrice() { return decoratorPrice; }
        public PaintChannel getDecoratorAverage() { return decoratorAverage; }
        public PaintChannel getDecoratorHistory() { return decoratorHistory; }

        // A paint object
        Paint oldUi = new Paint();

        public DecoratorChannel() { }

        public DecoratorChannel(string market)
        {
            this.market = market;
        }
