...
namespace PriceUI
{
    ...
    public partial class SplashForm : Form
    {
        ...
        private void PriceForm_New(object sender, EventArgs e)
        {
            ...
            ThreadStart threadDelegate = new ThreadStart(RunPriceFormTree);
        ...
        private void RunPriceFormTree()
        {
            Logs.Info("In RunPriceFormTree");
            ...
            PriceFormTree pft = new PriceFormTree(market);
            pft.ShowDialog();
            // The show dialog blocks until form is closed

            pft.PriceFormTree_Close();
